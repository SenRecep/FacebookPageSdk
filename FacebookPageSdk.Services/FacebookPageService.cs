        ...
        public IEnumerable<Post> GetPosts()
        {
            ...
            if (postNodes != null)
                foreach (var post in postNodes)
                {
                    ...
                    var likeCount = post.SelectSingleNode("article/footer/div/div[1]/a/div/div[1]/div");
                    var commentCount = post.SelectSingleNode("article/footer/div/div[1]/a/div/div[2]/span[1]");
                    var shareCount = post.SelectSingleNode("article/footer/div/div[1]/a/div/div[2]/span[2]");
                    var detailPageLink = post.SelectSingleNode("article/footer/div/div[1]/a");
